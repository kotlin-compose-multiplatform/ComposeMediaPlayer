...
### Note:
Currently, you also need to manually include JavaFX dependencies for your platform as described in the [Known Issues](#⚠️-Known-Issues) section. A patch is being developed to address this requirement.
